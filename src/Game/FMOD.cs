...
namespace BombermanOnline {
    static class FMOD {
        internal static System _system;
        ...
        public static void Init(string rootDir) => Init(rootDir, 256, 4, 32, INITFLAGS.CHANNEL_LOWPASS | INITFLAGS.CHANNEL_DISTANCEFILTER);
        public static void Init(string rootDir, uint dspBufferLength, int dspBufferCount, int maxChannels, INITFLAGS initFlags) {
            _rootDir = rootDir;
            LoadNativeLibrary();
            Factory.System_Create(out System system);
            _system = system;
            _system.setDSPBufferSize(dspBufferLength, dspBufferCount);
            _system.init(maxChannels, initFlags, (IntPtr)0);
        }
        ...
        public static Sound LoadSound(string name) {
            ...
            _system.createSound(buffer, MODE.OPENMEMORY | MODE.CREATESAMPLE, ref info, out var newSound);
        ...
        public static Sound LoadStreamedSound(string name) {
            ...
            info.length = (uint)buffer.Length;
            info.cbsize = Marshal.SizeOf(info);
            _system.createStream(buffer, MODE.OPENMEMORY | MODE.CREATESTREAM, ref info, out var newSound);
            return new Sound(newSound, buffer, handle);
        }

        public static void Update() => _system.update();
        ...
        static byte[] LoadFileAsBuffer(string path) {
        ...
        public class Sound {
            ...
            /// <summary>Amount of loops
            /// > 0 - Specific count
            /// 0 - No loops
            /// -1 - Infinite loops</summary>
            public int Loops = 0;
            /// <summary>Sound pitch. Affects speed too
            /// 1 - Normal pitch
            /// More than 1 - Higher pitch
            /// Less than 1 - Lower pitch</summary>
            public float Pitch = 1;
            public float Volume = 1;
            /// <summary>Low pass filter. Makes sound muffled
            /// 1 - No filtering
            /// 0 - Full filtering</summary>
            ...
            public Sound(FMODSound sound, byte[] buffer, GCHandle bufferHandle) {
                _sound = sound;
                _buffer = buffer;
            ...
            public SoundChannel Play(bool paused = false) => Play(ChannelGroup, paused);

            public SoundChannel Play(ChannelGroup group, bool paused = false) {
                _system.playSound(_sound, group, paused, out Channel fmodChannel);
        ...
        public class SoundChannel {
            ...
            public float LowPass {
                ...
                set => _channel.setLowPassGain(value);
            }

            public MODE Mode {
                get {
                    _channel.getMode(out MODE mode);
                    return mode;
                }
                set => _channel.setMode(value);
            }
            ...
            public uint TrackPosition {
                get {
                    _channel.getPosition(out uint position, TIMEUNIT.MS);
                    return position;
                }
                set => _channel.setPosition(value, TIMEUNIT.MS);
            }

            public SoundChannel(Sound sound, Channel channel) {
                Sound = sound;
                _channel = channel;
                Loops = Sound.Loops;
                Volume = Sound.Volume;
            ...
            public void Pause() => _channel.setPaused(true);
            public void Resume() => _channel.setPaused(false);
        ...
        public enum SYSTEM_CALLBACK_TYPE : uint {
            ...
            MEMORYALLOCATIONFAILED = 0x00000004, /* Called directly when a memory allocation fails somewhere in   (NOTE - 'system' will be NULL in this callback type.)*/
        ...
        */
        public struct System {
            ...
            */
            ...
            public RESULT createSound(string name, MODE mode, ref CREATESOUNDEXINFO exinfo, out FMODSound sound) {
                using(StringHelper.ThreadSafeEncoding encoder = StringHelper.GetFreeHelper()) {
            ...
            public RESULT createSound(IntPtr name_or_data, MODE mode, ref CREATESOUNDEXINFO exinfo, out FMODSound sound) {
                return FMOD5_System_CreateSound(this.handle, name_or_data, mode, ref exinfo, out sound.handle);
            }
            public RESULT createSound(string name, MODE mode, out FMODSound sound) {
                CREATESOUNDEXINFO exinfo = new CREATESOUNDEXINFO();
                exinfo.cbsize = Marshal.SizeOf(exinfo);

                return createSound(name, mode, ref exinfo, out sound);
            }
            public RESULT createStream(string name, MODE mode, ref CREATESOUNDEXINFO exinfo, out FMODSound sound) {
                using(StringHelper.ThreadSafeEncoding encoder = StringHelper.GetFreeHelper()) {
                    return FMOD5_System_CreateStream(this.handle, encoder.byteFromStringUTF8(name), mode, ref exinfo, out sound.handle);
                }
            }
            public RESULT createStream(byte[] data, MODE mode, ref CREATESOUNDEXINFO exinfo, out FMODSound sound) {
                return FMOD5_System_CreateStream(this.handle, data, mode, ref exinfo, out sound.handle);
            }
            public RESULT createStream(IntPtr name_or_data, MODE mode, ref CREATESOUNDEXINFO exinfo, out FMODSound sound) {
                return FMOD5_System_CreateStream(this.handle, name_or_data, mode, ref exinfo, out sound.handle);
            }
            public RESULT createStream(string name, MODE mode, out FMODSound sound) {
                CREATESOUNDEXINFO exinfo = new CREATESOUNDEXINFO();
                exinfo.cbsize = Marshal.SizeOf(exinfo);
            ...
            public RESULT createSoundGroup(string name, out FMODSoundGroup soundgroup) {
                using(StringHelper.ThreadSafeEncoding encoder = StringHelper.GetFreeHelper()) {
            ...
            public RESULT playSound(FMODSound sound, ChannelGroup channelgroup, bool paused, out Channel channel) {
            ...
            public RESULT getMasterSoundGroup(out FMODSoundGroup soundgroup) {
            ...
            public RESULT recordStart(int id, FMODSound sound, bool loop) {
...
#region wrapperinternal
        ...
        */
        public struct FMODSound {
            ...
            public RESULT getSubSoundParent(out FMODSound parentsound) {
            ...
            public RESULT setSoundGroup(FMODSoundGroup soundgroup) {
                return FMOD5_Sound_SetSoundGroup(this.handle, soundgroup.handle);
            }
            public RESULT getSoundGroup(out FMODSoundGroup soundgroup) {
...
#region wrapperinternal
        ...
        */
        public struct Channel : IChannelControl {
            ...
            public RESULT getCurrentSound(out FMODSound sound) {
...
#region wrapperinternal
        ...
        */
        public struct FMODSoundGroup {
            ...
            public RESULT getSound(int index, out FMODSound sound) {
